...
BestInPlaceEditor.prototype = {
  ...
  loadValues : function() {
      if (this.formType == "select" || this.formType == "checkbox")
      {
          this.collection = this.element.attr("data-collection") || self.collection;
          if (this.collection != null)
            this.values = jQuery.parseJSON(this.collection);
      }
  },
